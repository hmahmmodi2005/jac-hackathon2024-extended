...
export default function page() {
  ...
  const handleSubmit = (e) => {
    ...
    const submittedAnswers = quiz.map((question, index) => {
      const inputName = question.Type === "SA" ? index.toString(): `question_${question.Question}`;
  ...
  return (
    <main className="h-full bg-base-300">
      <Header />
      <h2 className="pt-20 text-4xl text-center">{className == "Computer-Science" ? "Computer Science" : className} Quiz</h2>
