      ...
      <div className="grid grid-cols-1 gap-20 px-20 py-10 md:grid-cols-2 lg:grid-cols-3">
        <div className="min-h-full shadow-xl card bg-base-100">
          ...
          <div className="card-body bg-blue-500 rounded-b-[20px] text-white">
            ...
            <div className="justify-end card-actions">
              <Link href="/ChatRoom?class=Computer-Science&diflevel=beginner">
                <button className="btn btn-primary">Beginner</button>
              </Link>
              <Link href="/ChatRoom?class=Computer-Science&diflevel=intermediate">
                <button className="btn btn-primary">Intermediate</button>
              </Link>
              <Link href="/ChatRoom?class=Computer-Science&diflevel=advanced">
        ...
        <div className="min-h-full shadow-xl card bg-base-100">
          ...
          <div className="card-body bg-red-500 rounded-b-[20px] text-white">
            ...
            <div className="justify-end card-actions">
              <Link href="/ChatRoom?class=History&diflevel=beginner">
                <button className="btn btn-primary">Beginner</button>
              </Link>
              <Link href="/ChatRoom?class=History&diflevel=intermediate">
                <button className="btn btn-primary">Intermediate</button>
              </Link>
              <Link href="/ChatRoom?class=History&diflevel=advanced">
                <button className="btn btn-primary">Advanced</button>
              </Link>
            </div>
          </div>
        ...
        <div className="min-h-full shadow-xl card bg-base-100">
          ...
          <div className="card-body bg-green-500 rounded-b-[20px] text-white">
            ...
            <div className="justify-end card-actions">
              <Link href="/ChatRoom?class=Geography&diflevel=beginner">
                <button className="btn btn-primary">Beginner</button>
              </Link>
              <Link href="/ChatRoom?class=Geography&diflevel=intermediate">
                <button className="btn btn-primary">Intermediate</button>
              </Link>
              <Link href="/ChatRoom?class=Geography&diflevel=advanced">
                <button className="btn btn-primary">Advanced</button>
              </Link>
            </div>
          </div>
